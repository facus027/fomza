...
export default function Mision() {
  ...
  >
    <div>
      <h3 className="text-center text-2xl font-bold font-gotham italic uppercase tracking-wide lg:text-3xl xl:text-4xl">
        MISIÓN Y VISIÓN
      </h3>
    </div>
    ...
    <div className="flex flex-col gap-8 md:gap-7">
      ...
      >
        ...
        <h3 className="w-full text-sm lg:text-base md:ml-5 md:w-3/4 xl:text-xl font-gotham text-justify">
